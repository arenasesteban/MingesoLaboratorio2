                ...
                <div className="flex gap-8 ">
                    ...
                    <div className="flex h-fit">
                        <div className="bg-white border border-emerald-700 rounded-xl p-6 space-y-2 shadow-lg">
                            <h3 className="font-semibold uppercase text-gray-700">Detalle reparación</h3>
                            <div className="space-y-2">
                                <div className="flex justify-between items-end gap-16 text-sm text-gray-700">
                                    <div>
                                        <h4 className="font-medium">Reparaciones</h4>
                                        <p className="text-gray-600">Suma del costo de todas las reparaciones individuales realizadas al vehículo</p>
                                    </div>
                                ...
                                <div className="flex justify-between items-end gap-16 text-sm text-gray-700">
                                    <div>
                                        ...
                                        <p className="text-gray-600">Cargos adicionales</p>
                                    </div>
                                ...
                                <div className="flex justify-between items-end gap-16 text-sm text-gray-700">
                                    <div>
                                        ...
                                        <p className="text-gray-600">Reducciones</p>
                                    </div>
                                    <p>$ {registro.monto_descuentos}</p>
                                </div>
                                <div className="flex justify-between items-end gap-16 text-sm text-gray-700 border-t border-gray-400 pt-2">
                                    <div>
                                        <h4 className="font-medium">SUB Total</h4>
                                        <p className="text-gray-600">Costo total de las reparaciones antes de aplicar el IVA</p>
                                    </div>
                                ...
                                <div className="flex justify-between items-end gap-16 text-sm text-gray-700">
                                    <div>
                                        ...
                                        <p className="text-gray-600">Impuesto obligatorio calculado sobre el subtotal de las reparaciones</p>
                                    </div>
